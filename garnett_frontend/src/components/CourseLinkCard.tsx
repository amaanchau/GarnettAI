...
export default function CourseLinkCard({ courseCode, isVisible }: CourseLinkCardProps) {
  ...
  return (
    <Link
      ...
      className="inline-flex items-center gap-1 text-xs font-medium text-[#800020] hover:text-[#600018] underline underline-offset-2 decoration-[#800020]/30 hover:decoration-[#800020]/60 transition-colors"
    >
      {courseCode}
